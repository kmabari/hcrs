...
* പ്രൊഫൈൽ അപ്രൂവ് ആയിരിക്കുകയും പിൻ ലഭിക്കാതിരിക്കുകയോ മറന്നുപോവുകയോ ചെയ്തെങ്കിൽ, നിങ്ങളുടെ ജില്ലാ മാനേജരുമായോ അല്ലെങ്കിൽ നേരിട്ട് സപ്പോർട്ട് വഴിയോ ബന്ധപ്പെട്ട് പുതിയ ലോഗിൻ പിൻ റീസെറ്റ് ചെയ്ത് ലഭ്യമാക്കാവുന്നതാണ്.`;
    ...
    if (member) {
      return `പ്രിയ ${member.name}, താങ്കളുടെ ഈ ചോദ്യം ഞാൻ വിശദമായി പരിശോധിച്ചു. എച്ച്.സി.ആർ.എസ് സംബന്ധിച്ച കൂടുതൽ അസിസ്റ്റൻസ് സഹായിക്കാൻ വേണ്ടി താഴെ പറയുന്ന കീവേഡുകൾ ടൈപ്പ് ചെയ്ത് ചോദിച്ചാൽ ഞാൻ കൃത്യമായി പറഞ്ഞു തരാം:

* 📅 **കോടതി കേസ് വിവരങ്ങൾ അറിയാൻ:** 'കേസ്' അല്ലെങ്കിൽ 'കോടതി' എന്ന് ചോദിക്കുക.
* 📋 **സാമ്പത്തിക വിവര ശേഖരണ ഫോമിനെക്കുറിച്ച് കൂടുതൽ അറിയാൻ:** 'ക്ലൈം' അല്ലെങ്കിൽ 'രജിസ്ട്രി' എന്ന് ചോദിക്കുക.
* 💳 **ഡിജിറ്റൽ ഐഡി കാർഡ് എങ്ങനെ ഡൗൺലോഡ് ചെയ്യാം എന്നറിയാൻ:** 'കാർഡ്' എന്ന് ചോദിക്കുക.
* ✏️ **നിങ്ങളുടെ വിവരങ്ങളിൽ എന്തെങ്കിലും തിരുത്തൽ വരുത്താൻ:** 'തിരുത്താൻ' അല്ലെങ്കിൽ 'പ്രൊഫൈൽ' എന്ന് ചോദിക്കുക.
* 🔄 **മെമ്പർഷിപ്പ് പുതുക്കാൻ (Renewal):** 'പുതുക്കാൻ' എന്ന് ചോദിക്കുക.
* 📞 **സൊസൈറ്റി വിലാസവും ഹെഡ് ഓഫീസും:** 'ബന്ധപ്പെടാൻ' എന്ന് ചോദിക്കുക.

സംഘടനയുമായി ബന്ധപ്പെട്ട മറ്റു കാര്യങ്ങൾക്കും ഈ ചാറ്റിൽ നേരിട്ട് ചോദിക്കാവുന്നതാണ് സുഹൃത്തേ! 😊`;
    }
    
    return `HCRS 'വഴികാട്ടി AI' അസിസ്റ്റന്റിലേക്ക് സ്വാഗതം! 🤝

താങ്കൾ പൊതുവായ വിവരങ്ങളാണ് അന്വേഷിക്കുന്നതെന്ന് കരുതുന്നു. താഴെ പറയുന്ന പ്രധാന വിഷയങ്ങളെക്കുറിച്ചാണ് സംശയമെങ്കിൽ ആ പദം ടൈപ്പ് ചെയ്ത് ചോദിക്കാവുന്നതാണ്:

1. **'രജിസ്റ്റർ'** - (📝 പുതിയ മെമ്പർഷിപ്പ് എടുക്കുന്ന രൂപം)
2. **'ലക്ഷ്യം'** - (🎯 സൊസൈറ്റിയുടെ ലക്ഷ്യങ്ങളും ക്ലൈം ആനുകൂല്യങ്ങളും)
3. **'സേവനം'** - (💼 പ്രധാന അഡ്വാൻറ്റേജുകളും ഡിപെൻഡന്റ് സൗകര്യങ്ങളും)

നിങ്ങളുടെ വ്യക്തിഗത അക്കൗണ്ട് പരിശോധിക്കാനാണ് താങ്കൾ ഇവിടെ വന്നതെങ്കിൽ, മുകളിലുള്ള ബോക്സിൽ നിങ്ങളുടെ 10 അക്ക മൊബൈൽ നമ്പർ നൽകി വെരിഫൈ ചെയ്യാവുന്നതാണ്. 😊`;
  };
