Warning: truncated output (original token count: 37945)
...
2. STRICT PRIVACY LIMIT FOR OTHER PEOPLE'S INFORMATION:
   If a user asks for another person's name, phone, photo, receipt, or card details, you MUST strictly refu…7945 tokens truncated…s Flow] Validation failed: Full Name or Mobile Number missing");
